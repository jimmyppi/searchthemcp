...
*/
    ...
    * 
    * @param string   id        Id of form element to attach to
    * @param array    data      Autocomplete data
    * @param function matchfunc Function that takes a string and data as input.
    *                           Returns a list of matching strings that should
    *                           be added to the autocomplete list
    */
    function AutoComplete_Create (id, formid, data, matchfunc)
    {
        ...
        if (arguments[3] != null) {
            __AutoComplete[id]['maxitems'] = arguments[3];
            __AutoComplete[id]['firstItemShowing'] = 0;
            __AutoComplete[id]['lastItemShowing']  = arguments[3] - 1;
        }
    ...
    */
    function AutoComplete_ShowDropdown(id)
    {
        ...
        var matches = __AutoComplete[id]['matchfunc'](value, __AutoComplete[id]['data']);
        if (! (matches === undefined)) {
            for (i=0; i<matches.length; ++i) {
                toDisplay[toDisplay.length] = matches[i];
            }
        }
